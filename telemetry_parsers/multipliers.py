...
class Multipliers(Enum):
    ...
    MCU_PEDAL_READINGS_ACCELERATOR_PEDAL_1 = 1.0 / (5.0 / 4096.0)   # 5 (5V ref) / 4096 (12-bit ADC), others from linear equation
    MCU_PEDAL_READINGS_ACCELERATOR_PEDAL_2 = 1.0 / (3.3 / 4096.0)   # 3.3 (3.3V ref) / 4096 (12-bit ADC), others from linear equation
    MCU_PEDAL_READINGS_BRAKE_TRANDUCER_1 = 1.0 / (5.0 / 4096.0) # 5 (5V ref) / 4096 (12-bit ADC) * 15000 (psi) / 5 (supply V)
    MCU_PEDAL_READINGS_BRAKE_TRANDUCER_2 = 1.0 / (5.0 / 4096.0) # 5 (5V ref) / 4096 (12-bit ADC) * 15000 (psi) / 5 (supply V)
